...
class DatasetCatalog(object):
    ...
    DATASETS = {
        ...
        'aw_daytimeclear_train_cocostyle': {
            "img_dir": 'Adverse-Weather/daytime_clear',
            "ann_file": 'Adverse-Weather/daytime_clear/voc07_train.json',
        },
        'aw_daytimeclear_test_cocostyle': {
            "img_dir": 'Adverse-Weather/daytime_clear',
            "ann_file": 'Adverse-Weather/daytime_clear/voc07_test.json',
        },
        'aw_daytimefoggy_test_cocostyle': {
            "img_dir": 'Adverse-Weather/daytime_foggy',
            "ann_file": 'Adverse-Weather/daytime_foggy/voc07_test.json',
        },
        'aw_duskrainy_test_cocostyle': {
            "img_dir": 'Adverse-Weather/dusk_rainy',
            "ann_file": 'Adverse-Weather/dusk_rainy/voc07_train.json',
        },
        'aw_night_rainy_test_cocostyle': {
            "img_dir": 'Adverse-Weather/night_rainy',
            "ann_file": 'Adverse-Weather/night_rainy/voc07_train.json',
        },
        'aw_night_sunny_test_cocostyle': {
            "img_dir": 'Adverse-Weather/night_sunny',
            "ann_file": 'Adverse-Weather/night_sunny/voc07_test.json',
        },

        'aw_daytimeclear_instdiff_train_cocostyle': {
            "img_dir": 'Adverse-Weather_instdiff/daytimeclear',
            "ann_file": 'Adverse-Weather_instdiff/daytimeclear/voc07_train_centercrop.json',
        },
        'aw_daytimefoggy_instdiff_test_cocostyle': {
            "img_dir": 'Adverse-Weather_instdiff/daytimefoggy',
            "ann_file": 'Adverse-Weather_instdiff/daytimefoggy/voc07_train_centercrop.json',
        },
        'aw_duskrainy_instdiff_test_cocostyle': {
            "img_dir": 'Adverse-Weather_instdiff/duskrainy',
            "ann_file": 'Adverse-Weather_instdiff/duskrainy/voc07_train_centercrop.json',
        },
        'aw_night_rainy_instdiff_test_cocostyle': {
            "img_dir": 'Adverse-Weather_instdiff/nightrainy',
            "ann_file": 'Adverse-Weather_instdiff/nightrainy/voc07_train_centercrop.json',
        },
        'aw_night_sunny_instdiff_test_cocostyle': {
            "img_dir": 'Adverse-Weather_instdiff/nightsunny',
            "ann_file": 'Adverse-Weather_instdiff/nightsunny/voc07_train_centercrop.json',
        },
